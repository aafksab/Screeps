var roleHarvesterBig = {
    ...
    spawn: function(scale) {
        var harvestersBig = _.filter(Game.creeps, (creep) => creep.memory.role == 'harvestersBig');
        console.log('harvestersBig:' + harvesters.length + ' Max:' + scale);
